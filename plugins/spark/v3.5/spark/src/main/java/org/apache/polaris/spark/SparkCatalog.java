  ...
  public Table createTable(
    ...
    if (PolarisCatalogUtils.useIceberg(provider)) {
      ...
      if (PolarisCatalogUtils.useHudi(provider)) {
        // First make the call to polaris's spark catalog to actually call catalog service,
        // as hudi does not use the delegateCatalog in
        // HoodieCatalog's createTable impl
        // so will need to manually call it here.
